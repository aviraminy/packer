...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory(__webpack_require__(22), __webpack_require__(35), __webpack_require__(0), __webpack_require__(21));
	else if(typeof define === 'function' && define.amd)
		define(["react", "lodash", "moment", "react-dom"], factory);
	else if(typeof exports === 'object')
		exports["widgetB"] = factory(require("react"), require("lodash"), require("moment"), require("react-dom"));
	else
		root["widgetB"] = factory(root["react"], root["lodash"], root["moment"], root["react-dom"]);
